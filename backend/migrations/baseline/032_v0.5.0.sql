...
-- Fresh-install baseline for Kikoto v0.5.0 (schema version 032).
...
CREATE TABLE metadata_snapshot (
  ...
  fetched_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
, variant_key TEXT NOT NULL DEFAULT '', edition_language TEXT NOT NULL DEFAULT '', request_locale TEXT NOT NULL DEFAULT '', content_hash TEXT NOT NULL DEFAULT '');
...
INSERT INTO "workflow_definition" ("id", "code", "display_name", "description", "definition_json", "scope", "editable", "owner_user_id", "created_by_user_id") VALUES (7, 'availability_watch', 'Availability Watch', 'Monitor a shared pool of work codes and dispatch configured actions when a remote source becomes available.', '{"nodes":[{"id":"targets","type":"select_works","displayName":"Monitoring pool"},{"id":"check","type":"check_source_availability","displayName":"Check source availability"},{"id":"ready","type":"filter_candidates","displayName":"Ready pool"},{"id":"dispatch","type":"dispatch_child_workflows","displayName":"Dispatch configured action"}]}', 'system', 0, NULL, NULL);
