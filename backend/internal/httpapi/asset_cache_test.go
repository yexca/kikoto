...
func TestServeRevalidatedFileUsesIdentityETag(t *testing.T) {
	...
	serveRevalidatedFile(response, request, path, "RJ00000001/image/cover_4x3.png")
	...
	serveRevalidatedFile(revalidatedResponse, revalidatedRequest, path, "RJ00000001/image/cover_4x3.png")
	...
	serveRevalidatedFile(reboundResponse, reboundRequest, path, "RJ00000000/package.jpg")
