...
func TestMigrateAddsQueryIndexes(t *testing.T) {
	...
	for table, index := range map[string]string{
		...
		"availability_watch_target": "idx_availability_watch_target_state",
	} {
		var count int
