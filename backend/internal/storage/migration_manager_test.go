...
func TestMigratePreservesMislabeledV060Baseline(t *testing.T) {
	...
	if count != 1+latestNumberedMigrationVersion-34 || filename != "baseline/034_v0.5.5.sql" || checksum != originalChecksum || baselineChecksum != originalChecksum || value != `"retained"` {
