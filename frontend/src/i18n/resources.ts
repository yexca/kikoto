...
export const libraryEnglish = {
  ...
  bulkForkSummary: "Bulk workflow #{{runId}}: forked {{synced}}, failed {{failed}}.",
  ...
  en: {
    translation: {
      ...
      login: {
        ...
        subtitle: "Sign in with your Kikoto account.",
        username: "Username",
        password: "Password",
      ...
      setup: {
        title: "Set up Kikoto",
        subtitle: "Create the first administrator. You can add other users afterward.",
        ["setupToken"]: "Setup token",
        ["tokenHint"]:
          "Find the setup token in the server log or in the config folder as <file>{{file}}</file>. With Docker Compose, view the log with <cmd>{{command}}</cmd>.",
        ...
        ["invalidToken"]: "The setup token is incorrect. Copy it again from the server log.",
        complete: "Setup is already complete. Sign in instead.",
        usernameRequired: "Enter a username.",
        usernameReserved: "This username is reserved. Choose another.",
        usernameExists: "This username is already in use. Choose another.",
        ["passwordRequired"]: "Enter a password.",
        ["passwordTooShort"]: "Use at least 8 characters.",
        ["passwordPlaceholder"]: "Do not use a password from the documentation.",
        failed: "Setup failed",
      },
      settings: {
