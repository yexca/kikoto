...
import { Activity, Bell, Moon, Play, Search } from "lucide-react";
...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-background pb-24 lg:grid lg:grid-cols-[248px_minmax(0,1fr)]">
      ...
      <footer className="fixed inset-x-0 bottom-0 z-30 border-t bg-card/95 backdrop-blur">
        <div className="flex min-h-[72px] items-center justify-between gap-3 px-4 lg:px-6">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="truncate text-sm font-semibold">Nothing playing</div>
              <div className="truncate text-xs text-muted-foreground">Mini player remains visible across the app.</div>
            </div>
          </div>
        ...
        <nav className="grid grid-cols-4 border-t lg:hidden">
          {mobileTabs.map((id) => {
