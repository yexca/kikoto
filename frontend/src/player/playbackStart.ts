export function normalizePlaybackStartPosition(positionSeconds?: number) {
  return positionSeconds !== undefined && Number.isFinite(positionSeconds) && positionSeconds > 0
    ? positionSeconds
    : 0;
}
...
export function shouldCheckpointPause(
  ...
  return completedPlaybackInstanceKey === null
    || completedPlaybackInstanceKey !== currentPlaybackInstanceKey;
}
