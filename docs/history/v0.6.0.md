...
> Fresh installations reuse the packaged `baseline/034_v0.5.5.sql` snapshot;
> its filename reflects when it was generated during development, not the
> schema shipped in the tagged v0.5.5 release. Do not replace an existing
